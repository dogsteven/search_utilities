...
public class JpaQueryEntityLoader implements StringIdentifiableEntityLoader {
    private final EntityManager entityManager;

    private final SelectInStatementProvider statementProvider;

    public JpaQueryEntityLoader(EntityManager entityManager, SelectInStatementProvider statementProvider) {
    ...
    public <T extends StringIdentifiable> List<T> load(List<String> identifiers, Class<T> entityClass) {
        ...
        final var query = entityManager.createQuery(selectStatement, entityClass);
