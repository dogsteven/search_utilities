...
public class FoxQueryLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NULL", "BOOLEAN", "TRUE", "FALSE", "OFFSET_DATE_TIME", "LOCAL_DATE_TIME", 
			"LOCAL_DATE", "YEAR", "MONTH", "DAY", "HOUR", "MINUTE", "SECOND", "NUMBER", 
			"TEXT", "TEXT_ELEMENT", "WILDCARD_PATTERN", "WILDCARD_PATTERN_ELEMENT", 
			"FIELD", "IDENTIFIER", "WHITESPACE"
		};
	}
